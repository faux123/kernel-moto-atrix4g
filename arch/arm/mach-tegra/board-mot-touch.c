...
struct qtouch_ts_platform_data ts_platform_arowana_p_1_43 = 
{
/*	.flags		= (QTOUCH_SWAP_XY | */
/*			   QTOUCH_EEPROM_CHECKSUM), */
	.flags		= (QTOUCH_SWAP_XY | 
...
static int vkey_size_arowana_p_1_43[4][4] = 
            { {68,1024,76,76},    // KEY_MENU
              {203,1024,87,76},    // KEY_HOME
              {337,1024,87,76},    // KEY_BACK
              {472,1024,76,76}};  // KEY_SEARCH
					...
					struct kobj_attribute *attr, char *buf)
{
	...
	else if ( machine_is_arowana() )
	{
		return sprintf(buf, __stringify(EV_KEY) ":" __stringify(KEY_MENU) ":%d:%d:%d:%d:" 
		            ...
		            __stringify(EV_KEY) ":" __stringify(KEY_BACK) ":%d:%d:%d:%d:"
                            __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":%d:%d:%d:%d\n",
                            vkey_size_arowana_p_1_43[0][0],vkey_size_arowana_p_1_43[0][1],vkey_size_arowana_p_1_43[0][2],vkey_size_arowana_p_1_43[0][3],
                            vkey_size_arowana_p_1_43[1][0],vkey_size_arowana_p_1_43[1][1],vkey_size_arowana_p_1_43[1][2],vkey_size_arowana_p_1_43[1][3],
                            vkey_size_arowana_p_1_43[2][0],vkey_size_arowana_p_1_43[2][1],vkey_size_arowana_p_1_43[2][2],vkey_size_arowana_p_1_43[2][3],
                            vkey_size_arowana_p_1_43[3][0],vkey_size_arowana_p_1_43[3][1], vkey_size_arowana_p_1_43[3][2], vkey_size_arowana_p_1_43[3][3]);
	}
	else
		return 0;
};
...
void mot_setup_touch(struct i2c_board_info *info)
{
	...
	{
		/* Arowana follow Olympus P3 HW */
		info->platform_data = 
			&ts_platform_arowana_p_1_43;
	}
	else if ( machine_is_etna())
	{
		/* Etna product */
