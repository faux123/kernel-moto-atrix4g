...
extern int tegra_uartB_for_BCM;
static const NvU32 s_NvOdmPinMuxConfig_Uart_bcm[] = {
...
#if defined(CONFIG_GPS_BCM4750)
	    if(tegra_uartB_for_BCM){
	      *pPinMuxConfigTable = s_NvOdmPinMuxConfig_Uart_bcm;
	      *pCount = NV_ARRAY_SIZE(s_NvOdmPinMuxConfig_Uart_bcm);
	    }
#endif
        }
        break;
