...
enum {
   ...
   MASK_BP_STATUS0         = 0x0002,
   MASK_BP_STATUS1         = 0x0004,
   MASK_BP_STATUS2         = 0x0008,
};
typedef unsigned short mdm_ctrl_gpiomask;

#define MDM_CTRL_MAGIC 0xEF

/* List of IOCtl commands */
/* Common */
#define MDM_CTRL_IOCTL_SET_BP_PWRON _IOW(MDM_CTRL_MAGIC, 0, int)
#define MDM_CTRL_IOCTL_GET_BP_RESOUT _IOR(MDM_CTRL_MAGIC, 1, int)
#define MDM_CTRL_IOCTL_SET_INT_BP_RESOUT _IOW(MDM_CTRL_MAGIC, 2, int)

/* MDM6600 */
#define MDM_CTRL_IOCTL_SET_AP_STATUS _IOW(MDM_CTRL_MAGIC, 10, int)
#define MDM_CTRL_IOCTL_GET_BP_STATUS _IOR(MDM_CTRL_MAGIC, 11, int)
#define MDM_CTRL_IOCTL_SET_BP_RESIN _IOW(MDM_CTRL_MAGIC, 12, int)
#define MDM_CTRL_IOCTL_SET_BP_BYPASS _IOW(MDM_CTRL_MAGIC, 13, int)
#define MDM_CTRL_IOCTL_SET_BP_FLASH_MODE _IOW(MDM_CTRL_MAGIC, 14, int)
#define MDM_CTRL_IOCTL_SET_INT_BP_STATUS _IOW(MDM_CTRL_MAGIC, 15, int)

/* High-level interfaces (for testing, etc) */
#define MDM_CTRL_IOCTL_BP_STARTUP _IOW(MDM_CTRL_MAGIC, 20, int)
#define MDM_CTRL_IOCTL_BP_SHUTDOWN _IO(MDM_CTRL_MAGIC, 21)

/* Legacy OMAP */
#define MDM_CTRL_IOCTL_SET_BP_PSHOLD _IOW(MDM_CTRL_MAGIC, 100, int)
#define MDM_CTRL_IOCTL_SET_BP_FLASH_EN _IOW(MDM_CTRL_MAGIC, 101, int)
